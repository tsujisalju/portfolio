...
export default function Hero() {
  ...
  return (
    <FadeIn>
      <div className="container m-auto max-w-4xl flex flex-1 flex-col py-20 px-16 xl:px-0 space-y-4">
        <Link href={"/"}>
          <a>
            <Image
              src={"/img/projects/canary.jpg"}
              alt="smolpadok's avatar, Van the Turkish van cat looking to the left."
              height={96}
              width={96}
              layout="fixed"
        ...
        <h1 className="font-display text-4xl md:text-5xl">
          {intl.formatMessage({
            id: "Student, dev and design by day, 7 cats by alternate world.",
          })}
        </h1>
        ...
        <div className="flex flex-row pt-4 space-x-3">
          ...
          <Link href={"https://github.com/smolpadok"}>
            <a
              target={"_blank"}
              className={
                "text-stone-700 hover:text-stone-800 dark:text-stone-300 hover:dark:text-stone-200 transition duration-200"
