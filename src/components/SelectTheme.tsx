    ...
    <Menu as="div" className={"relative w-12"}>
      ...
      >
        ...
        >
          <Menu.Item key={"light"}>
            <div
              className="font-sans flex flex-row transition transition-75 justify-start items-center text-left space-x-3 text-lg py-1 px-2 hover:bg-stone-200 hover:dark:bg-stone-700 rounded-md"
