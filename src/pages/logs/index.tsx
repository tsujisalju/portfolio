...
export default function Logs({ allLogsData }: { allLogsData: Log[] }) {
  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto grid grid-cols-1 px-4 md:px-8 lg:grid-cols-3 my-8 gap-8 h-full">
        ...
        <div className="flex flex-col col-span-2 flex-1 space-y-2 px-2 md:px-6 py-8 rounded-lg bg-black/10 shadow-inner h-[600px] overflow-y-auto">
